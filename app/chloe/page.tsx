...
// ─── Dados da Chloe — edite aqui ────────────────────────────────────────────

const CREATOR = {
  name: "Chloe Herrera",
  username: "@chloeherrera",
  bio: "Só fica quem tem coragem de desvendar cada segredinho da sua ruivinha.... vem? 😜",
  profileImg: "/img/chloe_profile.png",   // troque pelo caminho da foto da Chloe
  coverImg: "/img/chloe_cover.png",       // troque pelo caminho da capa da Chloe
  stats: [
...
const FEED_ITEMS = [
  { id: "1", isFree: false, likes: 124, comments: 18, image: "/img/chloe_1.png" },
  { id: "2", isFree: false, likes: 341, comments: 47, image: "/img/chloe_2.png" },
];
