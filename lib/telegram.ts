...
export async function sendSaleNotification(amount: number, identifier: string, page: string | null, plan: string | null = null, transactionDate: string | null = null, isLive: boolean = false) {
