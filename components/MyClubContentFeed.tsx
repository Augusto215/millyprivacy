...
export default function MyClubContentFeed({
  onLockedClick,
          ...
          return (
            <button
              ...
              className={`flex flex-1 items-center justify-center gap-1.5 px-3 py-3.5 text-[15px] font-semibold transition ${
                active ? "text-[#d946a6]" : "text-black-400 hover:text-black-600"
              }`}
            >
              <Icon className={`h-3.5 w-3.5 ${active ? "text-[#d946a6]" : ""}`} />
              {tab.label}
            </button>
          );
        })}
    ...
    <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white">
      ...
      <div className="flex items-center justify-between px-4 py-3">
        <div className="flex items-center gap-2.5">
          <div className="h-8 w-8 overflow-hidden rounded-full bg-gradient-to-br from-[#d946a6]/40 to-[#f5f5f5] flex items-center justify-center">
        ...
        {!item.isFree && (
          <>
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 z-20">
              <button
                className="px-4 py-2 rounded-full font-semibold text-white transition hover:opacity-90"
                style={{
